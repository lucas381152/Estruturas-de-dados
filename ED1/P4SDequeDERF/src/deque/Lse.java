...
public class Lse
{
    ...
    {
        Msg.limpatela();
        Msg.msg_central ("PROCESSO DE INSERÇÃO NO FINAL - Aguarde implementação");
    } 
    ...
    {
        Msg.limpatela();
        Msg.msg_central ("PROCESSO DE CONSULTA POR CONTEÚDO - INT - Aguarde implementação");        Msg.msg_central ("Atenção! Aguarde a implementação da consulta por conteúdo INT!");
    }
